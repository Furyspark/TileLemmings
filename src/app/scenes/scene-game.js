...
Scene_Game.prototype.init = function() {
  ...
  // Fade in
  this.fadeIn(this.startMap.bind(this));
...
Scene_Game.prototype.createReplayIcon = function() {
  if(this.replayIcon == null) {
    ...
    this.replayIcon.sprite.animSpeed = 1 / 20;
...
Scene_Game.prototype.initControls = function() {
  ...
  // Frame backward
  Input.key.B.onRepeat.add(this.framePrevious, this);
  // Frame forward
  Input.key.N.onRepeat.add(this.frameNext, this);
  // Zooming
...
Scene_Game.prototype.releaseControls = function() {
  ...
  // Frame backward
  Input.key.B.onRepeat.remove(this.framePrevious, this);
  // Frame forward
  Input.key.N.onRepeat.remove(this.frameNext, this);
  // Zooming
...
Scene_Game.prototype.updateReplayIcon = function() {
