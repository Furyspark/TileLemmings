...
Scene_Base.prototype.update = function(dt) {
  if(Core.debugMode) {
    ...
    // this.debug.soundCounter.text = AudioManager._sounds.length.toString();
  }
}
...
Scene_Base.prototype.startDebug = function() {
  ...
  // Add sound counter
  // this.debug.soundCounter = new Text(AudioManager._sounds.length.toString());
  // this.debug.soundCounter.style.fontSize = 14;
  // this.debug.soundCounter.position.set(8, 24);
  // this.stage.addChild(this.debug.soundCounter);
}
